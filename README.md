...
## Status: v2.3.1 (see [CHANGELOG.md](CHANGELOG.md))

2.3 is the one that measures itself. A cold start into the Stage used to move
2,462 KB and keep none of it; it now moves 704 KB the first time and 127 KB the
second, the app records how long every screen takes to appear, and closing it
stops the server it started instead of leaving one behind.
